...
final class TranslatablePhpDocRule extends AbstractRule
{
    ...
    private const CANONICAL_CLASS = TranslatableMessage::class;
    ...
    private const COVERED_METHODS = [
        TranslatableFactoryInterface::class => 'createTranslatableMessage',
        TranslatableAwareTrait::class => 't',
    ];
