...
use PhpTuf\ComposerStager\Domain\Service\Precondition\CommitterPreconditions;
use PhpTuf\ComposerStager\Domain\Service\Precondition\CommonPreconditionsInterface;
use PhpTuf\ComposerStager\Domain\Value\Path\PathInterface;
use PhpTuf\ComposerStager\Tests\PHPUnit\TestCase;

/**
 * @coversDefaultClass \PhpTuf\ComposerStager\Domain\Service\Precondition\CommitterPreconditions
 *
 ...
 */
class CommitterPreconditionsUnitTest extends TestCase
{
    ...
    protected function createSut(): CommitterPreconditions
    {
        ...
        return new CommitterPreconditions($commonPreconditions);
    }
